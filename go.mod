...
require (
	...
	go.cryptoscope.co/luigi v0.3.6 // indirect
...
replace go.cryptoscope.co/margaret => github.com/ssbc/margaret v0.4.3

replace go.cryptoscope.co/luigi => github.com/ssbc/go-luigi v0.3.6

replace go.cryptoscope.co/netwrap => github.com/ssbc/go-netwrap v0.1.4

replace go.cryptoscope.co/secretstream => github.com/ssbc/go-secretstream v1.2.10

replace go.cryptoscope.co/muxrpc/v2 => github.com/ssbc/go-muxrpc/v2 v2.0.13

replace github.com/jvalinsky/mr_valinskys_adequate_bridge/internal/ssb => ./internal/ssb
