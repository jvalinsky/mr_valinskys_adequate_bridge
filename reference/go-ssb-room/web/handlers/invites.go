...
type inviteConsumeJSONResponse struct {
	...
	// Address is the key name expected by older clients (Oasis/Room1.0)
	Address string `json:"address"`

	// MultiserverAddress is the key name specified by the modern Room 2.0 tunneling spec
...
func (json inviteConsumeJSONResponder) SendSuccess() {
	var resp = inviteConsumeJSONResponse{
		...
		MultiserverAddress: json.multiservAddr,
	}
