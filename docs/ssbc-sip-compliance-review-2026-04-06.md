...
| 004 | Bendy Butt | **Non-compliant** | Findings 1, 2, 4. Encoding is broken. |
| 005 | HTTP Invites | **Compliant** | Multiserver address now correctly formatted. |
| 006 | HTTP Authentication | Not implemented | `httpAuth.*` methods not implemented. |
| 007 | Rooms 2 | **Partially compliant** | Core tunnel fixed; Findings 5, 6, 7 remain. |
| 008 | BFE | **Non-compliant** | Finding 3. Double-base64 on strings. |
